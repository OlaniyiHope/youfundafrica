...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" action="loginscriptt.php" method="POST">
    ...
    <div class="container" style="background-color:#f1f1f1">
      <button type="submit" name="" onclick="document.getElementById('id01').style.display='block'" class="cancelbtn">Cancel</button>
      <span class="">Do not have an account <a href="register.php">Sign Up?</a></span>
    </div>
  </form>
</div>
