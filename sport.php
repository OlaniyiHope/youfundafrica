                                                 ...
                                                 <li><a href="agi.php">Agriculture</a></li>
                                                  <li><a href="edu.php">Education</a></li>
                                                   <li><a href="tech.php">Technology</a></li>
                                                    <li><a href="sport.php">Energy and Environment</a></li>
                                            </ul>
                                        </li>
                ...
                <div class="col-xl-12">
                    <div class="help_info">
                        <div class="section_title mb-80">
                            <h3>
                               Any innovation or idea that is directed towards the healthiness of the environment and green energy would be supported yFA. <br>We believe that one of the elements of community sustainability is the maintenance and the productive harness of the environment.
                            </h3>
                        </div>
                    </div>
                </div>
