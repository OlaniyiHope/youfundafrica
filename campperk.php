...
<link rel="stylesheet" type="text/css" href="css/resca.css">
    ...
    <link rel="stylesheet" type="text/css" href="css/campperk.css">
  ...
  <button class="openbtn" onclick="openNav()">☰ Campaign dashboard</button>  
    <div class="film">
          ...
          <ul>
            ...
            <form action="campperkscript.php" method="POST">

              <div class="form-col">  
                
                <div class="col">
                  <p><strong> Add perk *</strong></p>
                  <h5>What is the title of your perk?</h5>
                  <input type="text" class="txt1" name="txttit" placeholder="My perk Title">
                </div>
                
                
                <div class="col wen">
                  <button type="submit" name="submit" style="color: #fff; background: #008000;" >SAVE & CONTINUE</button>
                </div>
              </div>
