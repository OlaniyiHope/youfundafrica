...
<link rel="stylesheet" type="text/css" href="css/payment.css">
	<link rel="stylesheet" type="text/css" href="css/respay.css">
    <!-- CSS here -->
...
<body>
    ...
    <!-- breadcam_area_end -->
<section class="bind">
				<h2 style="margin: auto;text-align: center; padding-left: 20px; margin-bottom: 50px; margin-top: 80px;">Before you launch your project, make sure that your payment is set up correctly to not lose time.</h2>
				<div class="aa">
				...
				<div class="bb">
					<div class="form">
						...
						<form action="payscript.php" method="POST">
							<div class="form-row">
								<h3 style="margin-left: 20px;">Bank Account Holder*</h3>
								<p style="margin-left: 20px;">Enter the information for the individual, business, or nonprofit receiving the funds collected from your campaign. You cannnot change this information after you launch your campaign once you receive your first contribution, we will ask you to return to this page to fill out the remainder of your bank account and identity information</p>

								
										<div class="dun">
								<div class="col">
									<p >Legal First Name</p>
									<input type="text" name="txtfname" class="txt1">
								</div>
										<div class="col">
									<p>Legal Last Name</p>
									<input type="text" name="txtlname" class="txt1">
								</div>
									</div>
								<div class="col age">
									<p style="text-align: center;">Date of Birth</p>
								<input type="text" name="txtdob" class="txt1">
								</div>	

									
									<div class="col daq">
									<p>Country of Legal Residence</p>
									
									<input type="text" name="txtcountry" class="txt1">
								</div>	
				...
				<div class="cc">
									<div class="form ">
						<h4>Setting up your business paypal account</h4>
						<p></p>
					</div>
				</div>
			</section>
