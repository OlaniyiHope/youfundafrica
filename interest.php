...
<link rel="stylesheet" type="text/css" href="css/interest.css">
	<link rel="stylesheet" type="text/css" href="css/resint.css">
    <!-- CSS here -->
...
<section class="bind">
				...
				<div class="bb">
					<div class="form">
						...
						<form  method="POST" action="intscript.php">
							<div class="form-row">
								
								<div class="col">
									<p style=" text-align: center;">Major Interest</p>
									<select id="country" onchange="validate()" name="txtinterest">
			  						<option disabled="true" selected="true">
									</option>
									<option value="Education">Education</option>
									<option value="Agriculture">Agriculture</option>
									<option value="Technology">Technology</option>
									<option value="Farming">Energy and Evironment</option>
									<option value="Togo">Health</option>
								</select>
								...
								<input type="text" name="txtinterest2" class="txt1" placeholder="Add another Interest">
								</div>	
							
									
										<div class="col" style="margin-top: 40px;">
								<h6>Give us a brief description about your interest</h6>
								<textarea class="area"></textarea>
								</div>
								
									<button type="submit" style="margin-top: 180px;" name="submit">Save</button>				
							</div>
