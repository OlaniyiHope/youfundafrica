...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/respacct.css">
    <!-- CSS here -->
...
<section class="bind">
				...
				<div class="bb">
					<div class="form">
						...
						<form  method="POST" action="acctscript.php">
							
							<div class="form-row">
								
								<div class="col">
									<p >Name</p>
									<input type="text" name="firstname" class="txt1" placeholder="FIRSTNAME  LASTNAME" required="">
									<h6>As shown on your valid ID</h6> 
								</div>

								<div class="col">
									<p>E-mail</p>
								<input type="email" name="email" class="txt1" required="">
								</div>	

								<div class="col">
									<p>Password</p>
								<input type="password" name="password_1" class="txt1" required="">
								</div>	
									<div class="col">
									<p>Confirm Password</p>
									<input type="password" name="password_2" class="txt1" required="">
								</div>	
