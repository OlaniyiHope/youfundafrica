                ...
                <div class="col-xl-6 col-md-6">
                    <div class="causes_info">
                        ...
                        <div class="target_rais_area d-flex">
                            ...
                            <div class="single_raise">
                                <span style="color: #000;">raised :</span>
                                <h4>$1530</h4>
                            </div>
                ...
                <div class="row">
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget">
                            ...
                            <p class="footer_text doanar"> <a class="first" href="#">About</a><br> <a class="first" href="#">Our Team</a> <br><a
                                    href="#">Contact Us</a><br><a class="first" href="#">Join YouFundAfrica</a></p>
