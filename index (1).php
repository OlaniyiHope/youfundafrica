                ...
                <div class="col-xl-12">
                    <div class="single_slider">
                        <div class="slider_text">
                            <h3>Support a Crowdfunding platform <br>
                                You Care About</h3>
                            <p>Africa community based crowd funding platform <br>
                                 </p>
                            <a href="register.php" class="boxed-btn2">Join Us Today</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                    ...
                    <div class="causes_info">
                        ...
                        <div class="target_rais_area d-flex">
                            ...
                            <div class="doante_btn">
                                <a href="donor.php" class="boxed_btn3">Donate Now</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-md-6">
                    <div class="causes_thumb">
                       <a href="causesd.html"> <img class="img-fluid" src="img/causes/1.png" alt=""></a>
        ...
        <div class="container">
            ...
            <div class="row">
                    ...
                    <div class="single_serve text-center">
                        ...
                        <h3>Technology</h3>
                        <p>Every sustainable community always find a way to incorporate technology into its system. We will work towards funding ideas and project that are focused on making life easier, faster and more productive at small expense. </p>
                    </div>
                </div>
                    <div class="col-xl-4 col-md-4">
                    <div class="single_serve text-center">
                        ...
                        <p>Any innovation or idea that is directed towards the healthiness of the environment and green energy would be supported yFA. We believe that one of the elements of community sustainability is the maintenance and the productive harness of the environment. </p>
                    </div>
                </div>
                <div class="col-xl-4 col-md-4">
                    <div class="single_serve text-center">
                        ...
                        <h3>Agriculture</h3>
                        <p>We will also be involved in making sure that food is not affordable and accessible without infringing on the producers/sellers. Therefore, we will be helping young and small scale community farmers to scale up their businesses under temporary supervision. </p>
                    </div>
                </div>
                <div class="col-xl-4 col-md-4">
                    <div class="single_serve text-center">
                        ...
                        <h3>Health</h3>
                        <p>We will direct funding towards the establishment and creation of primary healthcare ideas and systems that provides affordable services for communities. This is more about strengthening the existing healthcare systems and also promoting effective alternative means through funding. </p>
                    </div>
                </div>
                <div class="col-xl-4 col-md-4">
                    <div class="single_serve text-center">
                        ...
                        <h3>Education</h3>
                        <p>We want to reach out to both private and public schools in communities and work with them towards offering funding needed to take their education delivery to the next level. We will also engage individual idealists whose ideas are geared towards strengthening Community Education. </p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-xl-8">
                    <div class="help_slider_active owl-carousel">
                        <div class="single_help_wrap">
                            <div class="thumb">
                                <a href="causesd.html"><img src="img/help/1.png" alt=""></a>
                            ...
                            <div class="help_content">
                                ...
                                <a href="donor.php" class="boxed-btn4 ">Donate Now</a>
                            </div>
                        </div>
                        <div class="single_help_wrap">
                            <div class="thumb">
                             <a href="causesd.html"><img src="img/help/2.png" alt=""></a>
                            </div>
                            <div class="help_content">
                                <h3>Help Yeati to continue her <br>
                                    Primary Education</h3>
                ...
                <div class="col-xl-8 offset-xl-2 col-md-10 offset-md-1">
                    <div class="volunter_text text-center">
                        ...
                        <p>Inspires employees and organizations to support causes they care <br>
                            ...
                            changing our world.</p>
                        <a class="boxed-btn4" href="register.php">Join Now</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-xl-3 col-md-6 col-lg-3">
                        <div class="footer_widget">
                            ...
                            <p class="footer_text">Lagos, Nigeria <br>
                                +2347086865816 <br>
                                <a class="domain" href="hello@youfundafrica.com">hello@youfundafrica.com</a></p>
                            <div class="socail_links">
                                <ul>
                                    <li>
                                        <a href="youfundafrica">
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Designed with love <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="olaniyihoppee@gmail.com" target="_blank">Hope</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        </p>
                    </div>
                </div>
